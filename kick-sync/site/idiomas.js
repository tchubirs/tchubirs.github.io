...
const TEXTOS = {
  pt: {
    ...
    'auto.aOuvir': 'A analisar áudio · {feito}/{total} · {mb} MB',
    'auto.aVer': 'A identificar vítimas · {feito}/{total}',
    'auto.achei': '{n} tiroteios detetados',
    'auto.comMorte': ' · {n} com vítima identificada',
    'auto.nenhum': 'Nenhum tiroteio detetado nesse intervalo. Escolhe outro pedaço da noite, ou marca a kill à mão.',
  ...
  en: {
    ...
    'auto.aOuvir': 'Analysing audio · {feito}/{total} · {mb} MB',
    'auto.aVer': 'Identifying victims · {feito}/{total}',
    'auto.achei': '{n} firefights detected',
    'auto.comMorte': ' · {n} with a victim identified',
    'auto.nenhum': 'No firefight detected in that range. Pick another part of the night, or mark the kill by hand.',
  ...
  es: {
    ...
    'auto.achei': '{n} tiroteos detectados',
    'auto.comMorte': ' · {n} con alguien muriendo',
    'auto.nenhum': 'Ningún tiroteo detectado en ese intervalo. Elige otra parte de la noche, o marca la kill a mano.',
