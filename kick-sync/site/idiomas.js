...
const TEXTOS = {
  pt: {
    ...
    'app.rodape': 'Se fechares sem querer, fica tudo guardado neste telemóvel.',
    ...
    'auto.foiKill': 'foi kill · procurar iguais',
    'auto.aprendi': 'aprendi o som desta kill e achei {n} iguais na noite',
    'auto.semSom': 'não guardei som deste momento — corre a busca automática primeiro',
  ...
  en: {
    ...
    'app.rodape': 'If you close it by accident, everything stays saved on this device.',
    ...
    'auto.foiKill': 'was a kill · find the same',
    'auto.aprendi': 'learnt this kill\u2019s sound and found {n} like it tonight',
    'auto.semSom': 'no sound kept for this moment — run the automatic search first',
  ...
  es: {
    ...
    'app.rodape': 'Si lo cierras sin querer, todo queda guardado en este dispositivo.',
    ...
    'tw.carregar': 'Cargar los VODs',
    'tw.noite': 'Noche',
    'tw.tocar': 'Reproducir todo',
    'tw.parar': 'Parar todo',
    ...
    'auto.foiKill': 'fue kill · buscar iguales',
    'auto.aprendi': 'aprendí el sonido de esta kill y encontré {n} iguales en la noche',
    'auto.semSom': 'no guardé sonido de este momento — corre la búsqueda automática primero',
