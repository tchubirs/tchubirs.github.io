...
const TEXTOS = {
  pt: {
    ...
    'auto.ouvi': ' · ouvi {altos} sons altos, chumbei {chumbados} por serem graves, e o maior grupo teve {maiorGrupo} (precisa de {minTiros}).',
  ...
  en: {
    ...
    'auto.ouvi': ' · I heard {altos} loud sounds, rejected {chumbados} as too bassy, and the biggest group had {maiorGrupo} (it needs {minTiros}).',
  ...
  es: {
    ...
    'auto.ouvi': ' · oí {altos} sonidos fuertes, descarté {chumbados} por ser graves, y el grupo mayor tuvo {maiorGrupo} (necesita {minTiros}).',
