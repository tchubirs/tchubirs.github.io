...
import { vodsDoCanal, lerMaster, lerPlaylist, procurarCanais } from './kick.js?v=3a3ec93d86';
import { linhaDoCanal, janelaComum, onde, quantosNoAr, comNudge, paraLink, doLink } from './relogio.js?v=3a3ec93d86';
import { cortarTodosOsAngulos } from './baixar.js?v=3a3ec93d86';
import { alinharPeloSom, custoEstimadoMB } from './alinhar.js?v=3a3ec93d86';
import { agruparPorNoite, rotuloDaNoite } from './noites.js?v=3a3ec93d86';
import {
  novoMomento, acrescentar, remover, planoDaMontagem, ordenar, alternarVitima,
} from './momentos.js?v=3a3ec93d86';
import { planearCorte, executarCorte, nomeDoFicheiro } from './baixar.js?v=3a3ec93d86';
import { criarApanhador } from './frames.js?v=3a3ec93d86';
import { varrerNoite, custoVarrerMB } from './procurar-momentos.js?v=3a3ec93d86';
import { somDoCanal } from './alinhar.js?v=3a3ec93d86';
import { MAXIMO_S, mover, janelaInicial, nomeDoClipe } from './clipe.js?v=3a3ec93d86';
import { IDIOMAS, t, tn, definirIdioma, idiomaDoBrowser, idiomaActual, aplicarIdioma } from './idiomas.js?v=3a3ec93d86';
import { notaDeMorte, quemMorreu, medir, limiar, pareceMorto } from './morte.js?v=3a3ec93d86';
