...
const TEXTOS = {
  pt: {
    ...
    'retrato.semPrevia': 'A versão em retrato precisa que a pré-visualização carregue. Espera, ou usa o Exportar clipe ao lado.',
    ...
    'clipe.fimLabel': 'Fim',
    'clipe.recuar': '1 s para trás (com Shift, 0,2 s)',
    'clipe.avancar': '1 s para a frente (com Shift, 0,2 s)',
  ...
  en: {
    ...
    'retrato.semPrevia': 'The portrait version needs the preview to load. Wait, or use Export clip next to it.',
    ...
    'clipe.fimLabel': 'End',
    'clipe.recuar': '1 s back (hold Shift for 0.2 s)',
    'clipe.avancar': '1 s forward (hold Shift for 0.2 s)',
  ...
  es: {
    ...
    'retrato.semPrevia': 'La versión en retrato necesita que la vista previa cargue. Espera, o usa Exportar clip al lado.',
    'retrato.exportar': 'Exportar 9:16',
    ...
    'clipe.fimLabel': 'Fin',
    'clipe.recuar': '1 s atrás (con Shift, 0,2 s)',
    'clipe.avancar': '1 s adelante (con Shift, 0,2 s)',
