...
import { aacDeSegmentos } from './audio-ts.js?v=498644878a';
import { envolvente, desvio, consolidar, resolver, TAXA } from './sinal.js?v=498644878a';
import { segmentosNaJanela } from './kick.js?v=498644878a';
