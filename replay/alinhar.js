...
import { aacDeSegmentos } from './audio-ts.js?v=19750b9efc';
import { envolvente, desvio, consolidar, resolver, TAXA } from './sinal.js?v=19750b9efc';
import { segmentosNaJanela } from './kick.js?v=19750b9efc';
