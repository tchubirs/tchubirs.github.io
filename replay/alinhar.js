...
import { aacDeSegmentos } from './audio-ts.js?v=43e4e0bf1b';
import { envolvente, desvio, consolidar, resolver, TAXA } from './sinal.js?v=43e4e0bf1b';
import { segmentosNaJanela } from './kick.js?v=43e4e0bf1b';
