...
import { aacDeSegmentos } from './audio-ts.js?v=ae3b1b7aa8';
import { envolvente, desvio, consolidar, resolver, TAXA } from './sinal.js?v=ae3b1b7aa8';
import { segmentosNaJanela } from './kick.js?v=ae3b1b7aa8';
import { onde } from './relogio.js?v=ae3b1b7aa8';
